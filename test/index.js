...
import { gettextToI18next, i18nextToMo, i18nextToPo } from "i18next-conv"; // eslint-disable-line import/no-unresolved
...
const testFiles = {
  en: {
    ...
    no_fold_length_po: "./test/_testfiles/en/translation.noFoldLength.po",
...
describe("i18next-gettext-converter", () => {
  describe("gettextToI18next", () => {
    describe("convert a utf8 PO files to JSON", () => {
      it("en", () =>
        expect(
          gettextToI18next("en", readFileSync(testFiles.en.utf8)).then(
            JSON.parse,
          ),
      ...
      it("de", () =>
        ...
        ).to.become(requireTestFile(testFiles.de.utf8_expected)));
      ...
      it("ru", () =>
        ...
        ).to.become(requireTestFile(testFiles.ru.utf8_expected)));
      ...
      it("ja", () =>
        ...
        ).to.become(requireTestFile(testFiles.ja.utf8_expected)));
    });
    ...
    describe("convert a utf8 PO files to JSON in v4 format", () => {
      ...
      it("de", () =>
        ...
        ).to.become(requireTestFile(testFiles.de.utf8_v4_expected)));
      ...
      it("ru", () =>
        ...
        ).to.become(requireTestFile(testFiles.ru.utf8_v4_expected)));
      ...
      it("ja", () =>
        ...
        ).to.become(requireTestFile(testFiles.ja.utf8_v4_expected)));
    });
    ...
    it("should convert a latin13 PO files to JSON, for a given domain", () =>
      ...
      ).to.become(requireTestFile(testFiles.en.latin13_expected)));
    ...
    it("should filter incoming PO translations if a filter function is passed to options", () =>
      ...
      ).to.become(requireTestFile(testFiles.en.filtered)));
    ...
    it("should pass all keys unfiltered, when the PO has no comments", () =>
      ...
      ).to.become(requireTestFile(testFiles.en.filtered_no_comments)));
    ...
    describe("convert a utf8 PO file with msgid as an original string to a JSON file", () => {
      it("en", () =>
        ...
        ).to.become(requireTestFile(testFiles.en.utf8_msgid_expected)));
      ...
      it("de", () =>
        ...
        ).to.become(requireTestFile(testFiles.de.utf8_msgid_expected)));
    });
    ...
    describe("should skip empty values appropriately", () => {
      ...
      it("skipUntranslated", () =>
        ...
        ).to.become(requireTestFile(testFiles.en.untranslated_skipped)));

      it("skipUntranslated and keyasareference", () =>
        expect(
          gettextToI18next("en", readFileSync(testFiles.en.untranslated), {
            keyasareference: true,
            skipUntranslated: true,
    ...
    describe("should skip fuzzy values appropriately", () => {
      ...
      it("skipUntranslated", () =>
        ...
        ).to.become(requireTestFile(testFiles.en.fuzzy_skipped)));
  ...
  describe("i18nextToGettext", () => {
    ...
    it("should change the fold length when a foldLength option is supplied", () =>
      expect(
        i18nextToPo("en", readFileSync(testFiles.en.fold_length), {
          splitNewLine: true,
          foldLength: 0,
          noDate: true,
        }),
    ...
    it("should convert a JSON file to utf8 MO", () =>
      expect(
        i18nextToMo("en", readFileSync(testFiles.en.utf8_expected), {
          splitNewLine: true,
          noDate: true,
        }),
    ...
    it("should recognize nested object arrays and recurse through them", () =>
      expect(
        i18nextToPo(
          "en",
          readFileSync(testFiles.en.nested_array_of_objects_json),
          {
            splitNewLine: false,
            noDate: true,
          },
    ...
    describe("should return the correct plural forms for Portuguese", () => {
      [
        ...
        it(`${code} should have ${plural}`, () =>
          expect(
            i18nextToPo(code, "{}").then((result) => result.toString()),
  ...
  describe("persisting msgid_plural", () => {
    it("should convert to json merging the ids", () => {
      expect(
        gettextToI18next(
          "en",
          readFileSync(testFiles.en.persist_plural_id_po),
          {
            persistMsgIdPlural: true,
          },
        ).then(JSON.parse),
      ).to.become(requireTestFile(testFiles.en.persist_plural_id_json));
    });
    ...
    it("should convert to po splitting the ids", () =>
      expect(
        ...
        readFileSync(testFiles.en.persist_plural_id_po).subarray(0, -1),
      ));
  });
});
